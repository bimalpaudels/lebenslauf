...
export const CVEmptyState: React.FC<CVEmptyStateProps> = ({
  width,
  height,
  scale,
  standalone,
  ...
  const classes = cn(
    "flex flex-col items-center justify-center text-gray-500 text-center bg-white",
    standalone ? "rounded-none shadow-sm my-0" : "rounded-lg shadow-lg my-2.5"
  );
