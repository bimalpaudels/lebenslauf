...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <nav className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-slate-900 dark:text-white font-semibold text-xl">lebenslauf</span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-slate-600 dark:text-slate-300 hover:text-[#3ECF8E] transition-colors"
            >
              Features
            </a>
            <a
      ...
      <section
        id="features"
        className="relative z-10 px-6 py-20 bg-slate-200/30 dark:bg-slate-800/30 backdrop-blur-sm border-y border-slate-300/50 dark:border-slate-700/50"
      >
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white text-center mb-16">
            Everything You Need
          </h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl p-8 hover:bg-slate-50/80 dark:hover:bg-slate-700/60 transition-all duration-300 border border-slate-300/50 dark:border-slate-700/50">
