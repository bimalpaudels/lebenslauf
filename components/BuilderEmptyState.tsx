...
export const BuilderEmptyState: React.FC<BuilderEmptyStateProps> = ({
  ...
  const emptyStateWrapperClasses = "shrink-0";
  
  const emptyStateClasses = cn(
    "flex flex-col items-center justify-center text-gray-500 text-center",
    "bg-white rounded-none shadow-lg origin-top-left my-5"
  );

  return (
    <div 
      className={emptyStateWrapperClasses}
      style={{
